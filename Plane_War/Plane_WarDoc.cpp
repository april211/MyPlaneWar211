...
// Plane_WarDoc.cpp: CPlaneWarDoc 类的实现
//
...
CPlaneWarDoc::CPlaneWarDoc() noexcept
{
	// TODO: 在此添加一次性构造代码
...
void CPlaneWarDoc::SetTitle(LPCTSTR lpszTitle)
{

	CDocument::SetTitle(L"Plane War");//修改主窗口标题
