...
CPlaneWarApp::CPlaneWarApp() noexcept
{
	// 支持重新启动管理器
	...
	SetAppID(_T("Wuguangkai211.PlaneWar.AppID.NoVersion"));

	// TODO:  在此处添加构造代码，
	// 将所有重要的初始化放置在 InitInstance 中
}

// 建立唯一的 CPlaneWarApp 对象，程序自此开始执行
...
BOOL CPlaneWarApp::InitInstance()
{
	...
	// TODO: 应适当修改该字符串，
	// 例如修改为公司或组织名
	SetRegistryKey(_T("Wuguangkai211"));
